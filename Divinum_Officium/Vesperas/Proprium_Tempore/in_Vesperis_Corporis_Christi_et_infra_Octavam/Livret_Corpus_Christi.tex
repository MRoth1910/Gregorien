...
%  \newpage
%  \thispagestyle{empty}
  \setheaders{{{\scshape\addfontfeature{LetterSpace=3.0}}Per Octavam Corporis Christæ.}}{{{\scshape\addfontfeature{LetterSpace=3.0} #1}}}
 \section{
  \begin{center}
  {\large#1}
  \end{center}
...
\rubrique{Capitulum. \normaltext{Carissime: Nolite.} ut infra ad Vesperas Dominicis. Hymnus. \normaltext{Pange Lingua. 7.}}

℣. Cibávit iílos ex ádipe fruménti, allelúia.\\
...
\rubrique{Oratio ut infra ad Vesperas Dominicis, \normaltext{13.}}

\rubrique{Et fit commemoratio de Octava, Ant. \normaltext{O sacrum convivium. 10. ℣. Panem de cælo.} Oratio. \normaltext{Deus qui nobis. 10.}}
...
\vspace{2mm}
Feria Quarta. \rubrique{Ad Vesperas, omnia ut in I. Vesperis Festi, 2.}
