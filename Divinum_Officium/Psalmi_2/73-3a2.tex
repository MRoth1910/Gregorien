...
\item Et gloriáti sunt \textbf{qui} o\textbf{dé}\textbf{runt} te:~* in médio solemni\textit{tá}\textit{tis} \textbf{tu}æ.
...
\item Deus autem Rex noster \textbf{an}te \textbf{sǽ}\textbf{cu}la:~* operátus est salútem in mé\textit{di}\textit{o} \textbf{ter}ræ.
...
\item Memor esto hujus, inimícus imprope\textbf{rá}vit \textbf{Dó}\textbf{mi}no:~* et pópulus insípiens incitávit \textit{no}\textit{men} \textbf{tu}um.
