...
\item Vota mea Dómino reddam in conspéctu omnis \textbf{pó}puli \textbf{e}jus:~* in átriis domus Dómini, in médio tu\textit{i}, \textit{Je}\textbf{rú}\textbf{sa}lem.
\item Laudáte Dóminum, \textbf{om}nes \textbf{Gen}tes:~* laudáte eum, \textit{om}\textit{nes} \textbf{pó}\textbf{pu}li:
