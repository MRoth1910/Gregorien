...
\item Et gloriáti sunt \textbf{qui} o\textbf{dé}runt te:~* in médio solemni\textbf{tá}tis \textbf{tu}æ.
...
\item Deus autem Rex noster \textbf{an}te \textbf{sǽ}cula:~* operátus est salútem in \textbf{mé}dio \textbf{ter}ræ.
...
\item Memor esto hujus, inimícus imprope\textbf{rá}vit \textbf{Dó}mino:~* et pópulus insípiens incitávit \textbf{no}men \textbf{tu}um.
