\item Deus meus, clamábo per diem, et \textbf{non} ex\textbf{áu}\textbf{di}es:~* et nocte, et non ad insipién\textit{ti}\textit{am} \textbf{mi}hi.
...
\item Ad te clamavérunt, et \textbf{sal}vi \textbf{fac}\textbf{ti} sunt:~* in te speravérunt, et non \textit{sunt} \textit{con}\textbf{fú}si.
\item Ego autem sum vermis, \textbf{et} non \textbf{ho}mo:~* oppróbrium hóminum, et abjéc\textit{ti}\textit{o} \textbf{ple}bis.
\item Omnes vidéntes me \textbf{de}ri\textbf{sé}\textbf{runt} me:~* locúti sunt lábiis, et mo\textit{vé}\textit{runt} \textbf{ca}put.
...
\item Sicut \textbf{a}qua ef\textbf{fú}\textbf{sus} sum:~* et dispérsa sunt ómnia \textit{os}\textit{sa} \textbf{me}a.
...
\item Fodérunt manus meas et \textbf{pe}des \textbf{me}os:~* dinumeravérunt ómnia \textit{os}\textit{sa} \textbf{me}a.
\item Ipsi vero consideravérunt et \textbf{in}spe\textbf{xé}\textbf{runt} me:~* divisérunt sibi vestiménta mea, et super vestem meam mi\textit{sé}\textit{runt} \textbf{sor}tem.
...
\item Tímeat eum omne \textbf{se}men \textbf{Is}\textbf{ra}ël:~* quóniam non sprevit, neque despéxit deprecati\textit{ó}\textit{nem} \textbf{páu}peris:
...
\item Reminiscéntur et conver\textbf{tén}tur ad \textbf{Dó}\textbf{mi}num~* univérsi \textit{fi}\textit{nes} \textbf{ter}ræ:
