...
\item Beáti, qui hábitant in domo \textbf{tu}a, \textbf{Dó}\textbf{mi}ne:~* in sǽcula sæcu\textbf{ló}rum lau\textbf{dá}bunt te.
...
\item Non privábit bonis eos qui ámbulant in \textbf{in}no\textbf{cén}\textbf{ti}a:~* Dómine virtútum, beátus homo qui \textbf{spe}rat \textbf{in} te.
