...
\item De\textit{us}, \textit{con}\textbf{vér}te nos:~* et osténde fáciem tuam, \textit{et} \textit{sal}\textit{vi} \textbf{é}rimus.
...
\item Posuísti nos in contradictiónem vi\textit{cí}\textit{nis} \textbf{nos}tris:~* et inimíci nostri \textit{sub}\textit{san}\textit{na}\textbf{vé}runt nos.
\item Deus virtú\textit{tum}, \textit{con}\textbf{vér}te nos:~* et osténde fáciem tuam, \textit{et} \textit{sal}\textit{vi} \textbf{é}rimus.
...
\item Et non discédimus a te, vi\textit{vi}\textit{fi}\textbf{cá}bis nos:~* et nomen tu\textit{um} \textit{in}\textit{vo}\textbf{cá}bimus.
\item Dómine, Deus virtú\textit{tum}, \textit{con}\textbf{vér}te nos:~* et osténde fáciem tuam, \textit{et} \textit{sal}\textit{vi} \textbf{é}rimus.
