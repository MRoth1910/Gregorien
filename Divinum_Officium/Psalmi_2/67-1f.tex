...
\item Terra mota est, étenim cæli distillavérunt a fácie \textbf{De}i \textbf{Sí}nai,~* a fácie \textit{De}\textit{i} \textbf{Is}raël.
...
\item In ecclésiis benedícite \textbf{De}o \textbf{Dó}mino,~* de fón\textit{ti}\textit{bus} \textbf{Is}raël.
...
\item A templo tuo \textbf{in} Je\textbf{rú}salem,~* tibi ófferent \textit{re}\textit{ges} \textbf{mú}nera.
...
\item Ecce dabit voci suæ vocem virtútis, date glóriam Deo \textbf{su}per \textbf{Is}raël,~* magnificéntia ejus, et virtus e\textit{jus} \textit{in} \textbf{nú}bibus.
