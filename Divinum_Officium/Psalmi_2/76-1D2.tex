...
\item Cogitávi \textbf{di}es an\textbf{tí}quos:~* et annos ætérnos in \textit{men}\textit{te} \textbf{há}\textbf{bu}i.
...
\item Deus, in sancto via tua:~† quis Deus magnus sicut \textbf{De}us \textbf{nos}ter?~* tu es Deus qui facis \textit{mi}\textit{ra}\textbf{bí}\textbf{li}a.
...
\item Etenim sagíttæ \textbf{tu}æ \textbf{tráns}eunt:~* vox tonítrui tu\textit{i} \textit{in} \textbf{ro}ta.
...
\item Deduxísti sicut oves \textbf{pó}pulum \textbf{tu}um,~* in manu Móy\textit{si} \textit{et} \textbf{A}\textbf{a}ron.
