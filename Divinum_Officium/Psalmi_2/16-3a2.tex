\item Auribus pércipe orati\textbf{ó}nem \textbf{me}am,~* non in lábi\textit{is} \textit{do}\textbf{ló}sis.
\item De vultu tuo judícium \textbf{me}um \textbf{pród}\textbf{e}at:~* óculi tui vídeant \textit{æ}\textit{qui}\textbf{tá}tes.
...
\item Ut non loquátur os meum \textbf{ó}pera \textbf{hó}\textbf{mi}num:~* propter verba labiórum tuórum ego custodívi \textit{vi}\textit{as} \textbf{du}ras.
...
\item A resisténtibus déxteræ \textbf{tu}æ cus\textbf{tó}\textbf{di} me,~* ut pu\textit{píl}\textit{lam} \textbf{ó}culi.
...
\item Projiciéntes me nunc cir\textbf{cum}de\textbf{dé}\textbf{runt} me:~* óculos suos statuérunt decliná\textit{re} \textit{in} \textbf{ter}ram.
...
\item Satu\textbf{rá}ti sunt \textbf{fí}\textbf{li}is:~* et dimisérunt relíquias suas pár\textit{vu}\textit{lis} \textbf{su}is.
