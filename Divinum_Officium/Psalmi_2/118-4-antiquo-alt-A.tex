...
\item Quot sunt dies \textit{ser}\textit{vi} \textbf{tu}i?~* quando fácies de persequénti\textit{bus} \textit{me} \textit{ju}\textbf{dí}cium?
...
\item Quómodo diléxi legem \textit{tu}\textit{am}, \textbf{Dó}mine?~* tota die medi\textit{tá}\textit{ti}\textit{o} \textbf{me}a est.
...
\item Declarátio sermónum tuó\textit{rum} \textit{il}\textbf{lú}minat:~* et intel\textit{léc}\textit{tum} \textit{dat} \textbf{pár}vulis.
