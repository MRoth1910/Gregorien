...
\item Ne simul trahas me cum \textbf{pec}ca\textbf{tó}ribus:~* et cum operántibus iniquitá\textit{tem} \textit{ne} \textbf{per}\textbf{das} me.
...
\item Dóminus adjútor meus, et pro\textbf{téc}tor \textbf{me}us:~* in ipso sperávit cor meum \textit{et} \textit{ad}\textbf{jú}\textbf{tus} sum.
\item Et reflóruit \textbf{ca}ro \textbf{me}a:~* et ex voluntáte mea confi\textit{té}\textit{bor} \textbf{e}i.
\item Dóminus fortitúdo \textbf{ple}bis \textbf{su}æ:~* et protéctor salvatiónum \textit{Chris}\textit{ti} \textbf{su}\textbf{i} est.
