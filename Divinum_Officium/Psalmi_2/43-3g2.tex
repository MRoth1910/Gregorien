\item Opus, quod operátus es in di\textbf{é}bus e\textbf{ó}rum,~* et in di\textit{é}\textit{bus} \textit{an}\textbf{tí}quis.
...
\item Nunc autem repulísti et \textbf{con}fu\textbf{dís}\textbf{ti} nos:~* et non egrediéris, Deus, in vir\textit{tú}\textit{ti}\textit{bus} \textbf{nos}tris.
\item Avertísti nos retrórsum post ini\textbf{mí}cos \textbf{nos}tros:~* et qui odérunt nos, diri\textit{pi}\textit{é}\textit{bant} \textbf{si}bi.
...
\item Si oblíti sumus nomen \textbf{De}i \textbf{nos}tri,~* et si expándimus manus nostras ad de\textit{um} \textit{a}\textit{li}\textbf{é}num:
