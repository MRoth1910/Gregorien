...
\item Confitébor tibi in \textbf{pó}pulis, \textbf{Dó}\textbf{mi}ne:~* et psallam tibi in \textit{na}\textit{ti}\textbf{ó}nibus.
...
\item Salvum fac déxtera tua, \textbf{et} ex\textbf{áu}\textbf{di} me:~* Deus locútus est in \textit{sanc}\textit{to} \textbf{su}o:
\item Exsultábo, et \textbf{dí}vidam \textbf{Sí}\textbf{chi}mam:~* et convállem tabernaculó\textit{rum} \textit{di}\textbf{mé}tiar.
...
\item Nonne tu, Deus, qui \textbf{re}pu\textbf{lís}\textbf{ti} nos,~* et non exíbis, Deus, in virtú\textit{ti}\textit{bus} \textbf{nos}tris?
