...
\item Cogitávi di\textit{es} \textit{an}\textbf{tí}quos:~* et annos ætérnos \textit{in} \textit{men}\textit{te} \textbf{há}\textbf{bu}i.
...
\item Deus, in sancto via tua:~† quis Deus magnus sicut \textit{De}\textit{us} \textbf{nos}ter?~* tu es Deus qui fa\textit{cis} \textit{mi}\textit{ra}\textbf{bí}\textbf{li}a.
...
\item Deduxísti sicut oves pó\textit{pu}\textit{lum} \textbf{tu}um,~* in manu Mó\textit{y}\textit{si} \textit{et} \textbf{A}\textbf{a}ron.
