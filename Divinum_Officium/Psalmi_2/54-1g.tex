\item Contristátus sum in exercitati\textbf{ó}ne \textbf{me}a:~* et conturbátus sum a voce inimíci, et a tribulatióne \textit{pec}\textit{ca}\textbf{tó}ris.
...
\item Timor et tremor ve\textbf{né}runt \textbf{su}per me:~* et contexé\textit{runt} \textit{me} \textbf{té}nebræ.
\item Et dixi: Quis dabit mihi pennas \textbf{sic}ut co\textbf{lúm}bæ,~* et volábo, et \textit{re}\textit{qui}\textbf{és}cam?
\item Ecce elon\textbf{gá}vi \textbf{fú}giens:~* et mansi in \textit{so}\textit{li}\textbf{tú}dine.
...
\item Die ac nocte circúmdabit eam super muros \textbf{e}jus in\textbf{í}quitas:~* et labor in médio ejus, et \textit{in}\textit{jus}\textbf{tí}tia.
...
\item Ego autem ad \textbf{De}um cla\textbf{má}vi:~* et Dómi\textit{nus} \textit{sal}\textbf{vá}bit me.
...
\item Mollíti sunt sermónes ejus \textbf{su}per \textbf{ó}leum:~* et ip\textit{si} \textit{sunt} \textbf{já}cula.
