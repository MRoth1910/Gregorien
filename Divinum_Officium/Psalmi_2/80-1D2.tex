\item Súmite psalmum, et \textbf{da}te \textbf{tým}panum:~* psaltérium jucún\textit{dum} \textit{cum} \textbf{cí}\textbf{tha}ra.
...
\item Si pópulus \textbf{me}us au\textbf{dís}set me:~* Israël si in viis meis \textit{am}\textit{bu}\textbf{lás}set:
...
\item Inimíci Dómini men\textbf{tí}ti sunt \textbf{e}i:~* et erit tempus eó\textit{rum} \textit{in} \textbf{sǽ}\textbf{cu}la.
