...
\item Ideo audívit Dómi\textbf{nus}, et \textbf{dís}\textbf{tu}lit:~* et ignis accénsus est in Jacob, et ira ascén\textit{dit} \textit{in} \textbf{Is}raël.
\item Quia non credi\textbf{dé}runt in \textbf{De}o:~* nec speravérunt in salu\textit{tá}\textit{ri} \textbf{e}jus:
\item Et mandávit \textbf{nú}bibus \textbf{dé}\textbf{su}per:~* et jánuas cæ\textit{li} \textit{a}\textbf{pé}ruit.
...
\item Et recordátus est \textbf{qui}a \textbf{ca}\textbf{ro} sunt:~* spíritus vadens \textit{et} \textit{non} \textbf{réd}iens.
...
\item Et excitátus est tamquam \textbf{dór}miens \textbf{Dó}\textbf{mi}nus:~* tamquam potens crapulá\textit{tus} \textit{a} \textbf{vi}no.
...
\item Et elégit David, servum suum, et sústulit eum de \textbf{gré}gibus \textbf{ó}\textbf{vi}um:~* de post fœtántes ac\textit{cé}\textit{pit} \textbf{e}um,
