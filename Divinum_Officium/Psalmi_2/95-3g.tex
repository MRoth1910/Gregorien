...
\item Quóniam omnes dii Génti\textbf{um} dæ\textbf{mó}\textbf{ni}a:~* Dóminus autem \textit{cæ}\textit{los} \textbf{fe}cit.
...
\item Etenim corréxit orbem terræ qui non \textbf{com}mo\textbf{vé}\textbf{bi}tur:~* judicábit pópulos in \textit{æ}\textit{qui}\textbf{tá}te.
