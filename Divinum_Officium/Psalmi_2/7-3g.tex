...
\item Justum adjutórium \textbf{me}um a \textbf{Dó}\textbf{mi}no,~* qui salvos facit \textit{rec}\textit{tos} \textbf{cor}de.
\item Deus judex justus, \textbf{for}tis, et \textbf{pá}\textbf{ti}ens:~* numquid iráscitur per sín\textit{gu}\textit{los} \textbf{di}es?
...
\item Ecce partúriit \textbf{in}jus\textbf{tí}\textbf{ti}am:~* concépit dolórem, et péperit in\textit{i}\textit{qui}\textbf{tá}tem.
