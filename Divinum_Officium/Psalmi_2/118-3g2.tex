...
\item Retríbue servo tuo, vi\textbf{ví}fi\textbf{ca} me:~* et custódiam \textit{ser}\textit{mó}\textit{nes} \textbf{tu}os.
...
\item Legem pone mihi, Dómine, viam justificati\textbf{ó}num tu\textbf{á}rum:~* et exquí\textit{ram} \textit{e}\textit{am} \textbf{sem}per.
...
\item Memor esto verbi tui \textbf{ser}vo \textbf{tu}o,~* in quo mi\textit{hi} \textit{spem} \textit{de}\textbf{dís}ti.
...
\item Bonitátem fecísti cum servo \textbf{tu}o, \textbf{Dó}\textbf{mi}ne:~* secún\textit{dum} \textit{ver}\textit{bum} \textbf{tu}um.
...
\item Defécit in salutáre tuum \textbf{á}nima \textbf{me}a:~* et in verbum tuum \textit{su}\textit{per}\textit{spe}\textbf{rá}vi.
...
\item Quómodo diléxi legem \textbf{tu}am, \textbf{Dó}\textbf{mi}ne?~* tota die medi\textit{tá}\textit{ti}\textit{o} \textbf{me}a est.
...
\item Iníquos \textbf{ó}dio \textbf{há}\textbf{bu}i:~* et legem \textit{tu}\textit{am} \textit{di}\textbf{lé}xi.
...
\item Mirabília testi\textbf{mó}nia \textbf{tu}a:~* ídeo scrutáta est ea \textit{á}\textit{ni}\textit{ma} \textbf{me}a.
...
\item Clamávi in toto corde meo, ex\textbf{áu}di me, \textbf{Dó}\textbf{mi}ne:~* justificatiónes \textit{tu}\textit{as} \textit{re}\textbf{quí}ram.
...
\item Príncipes persecúti \textbf{sunt} me \textbf{gra}tis:~* et a verbis tuis formi\textit{dá}\textit{vit} \textit{cor} \textbf{me}um.
