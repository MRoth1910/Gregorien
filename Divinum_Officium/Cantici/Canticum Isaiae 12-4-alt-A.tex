\item Ecce Deus sal\textit{vá}\textit{tor} \textbf{me}us,~* fiduciáliter agam, \textit{et} \textit{non} \textit{ti}\textbf{mé}bo.
...
\item Exsúlta et lauda habitá\textit{ti}\textit{o} \textbf{Si}on:~* quia magnus in médio tu\textit{i} \textit{sanc}\textit{tus} \textbf{Is}rael.
