...
\item Date magnificéntiam Deo nostro.~† Dei per\textbf{féc}ta sunt \textbf{ó}pera,~* et omnes viæ e\textit{jus} \textit{ju}\textbf{dí}cia:
...
\item Vidit Dóminus, et ad iracúndiam \textbf{con}ci\textbf{tá}tus est:~* quia provocavérunt eum fílii su\textit{i} \textit{et} \textbf{fí}liæ.
\item Et ait: Abscóndam fáciem \textbf{me}am ab \textbf{e}is,~* et considerábo novíssi\textit{ma} \textit{e}\textbf{ó}rum:
\item Generátio \textbf{e}nim per\textbf{vér}sa est,~* et infi\textit{dé}\textit{les} \textbf{fí}lii.
