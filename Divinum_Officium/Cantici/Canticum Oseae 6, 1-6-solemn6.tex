\item Vivificábit nos post duos dies:~† in die térti\textit{a} \textit{su}\textit{sci}\textbf{tá}\textbf{bit} nos,~* et vivémus in \textit{con}\textit{spéc}\textit{tu} \textbf{e}jus.
