...
\item Date magnificéntiam Deo nostro.~† Dei per\textit{féc}\textit{ta} \textit{sunt} \textbf{ó}pera,~* et omnes viæ \textit{e}\textit{jus} \textit{ju}\textbf{dí}\textbf{ci}a:
...
\item Vidit Dóminus, et ad iracúndi\textit{am} \textit{con}\textit{ci}\textbf{tá}tus est:~* quia provocavérunt eum fílii \textit{su}\textit{i} \textit{et} \textbf{fí}\textbf{li}æ.
...
\item Generátio \textit{e}\textit{nim} \textit{per}\textbf{vér}sa est,~* et in\textit{fi}\textit{dé}\textit{les} \textbf{fí}\textbf{li}i.
