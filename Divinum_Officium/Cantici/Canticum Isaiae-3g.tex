...
\item Non in abscóndi\textbf{to} lo\textbf{cú}\textbf{tus} sum,~* in loco terræ \textit{te}\textit{ne}\textbf{bró}so:
...
\item Numquid non ego Dóminus, et non est ultra \textbf{De}us \textbf{abs}\textbf{que} me?~* Deus justus, et salvans \textit{non} \textit{est} \textbf{præ}ter me.
...
\item Ergo in Dómino, dicet, meæ sunt justítiæ \textbf{et} im\textbf{pé}\textbf{ri}um:~* ad eum vénient, et confundéntur omnes qui re\textit{pú}\textit{gnant} \textbf{e}i.
\item In Dómino justificábitur, \textbf{et} lau\textbf{dá}\textbf{bi}tur~* omne \textit{se}\textit{men} \textbf{Is}raël.
