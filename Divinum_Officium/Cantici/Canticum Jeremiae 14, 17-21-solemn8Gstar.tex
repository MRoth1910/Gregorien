...
\item Si egréssus fúero ad agros, ecce \textit{oc}\textit{cí}\textit{si} \textbf{glá}dio:~* et si introíero in civitátem, ecce attenu\textit{á}\textit{ti} \textbf{fa}me.
...
\item Quare er\textit{go} \textit{per}\textit{cus}\textbf{sís}ti nos,~* ita ut nul\textit{la} \textit{sit} \textbf{sá}nitas?
